from day2_regex import (extract_course_times, get_all_hashtags_and_links, match_first_paragraph)

def test_extract_course_times_default_args():
    expected = ['01:47', '32:03', '41:51', '27.48', '05:02']
    assert extract_course_times() == expected


def test_extract_course_times_other_inputs():
...
def test_get_all_hashtags_and_links_def_args():
